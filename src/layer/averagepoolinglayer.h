#ifndef AVERAGEPOOLINGLAYER_H
#define AVERAGEPOOLINGLAYER_H
...
public:
    ...
    AveragePoolingLayer(AbstractLayer * prev);

    AveragePoolingLayer(std::istream & stream,AbstractLayer * prev);

    ~AveragePoolingLayer() override;
